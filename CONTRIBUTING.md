...
```bash
git clone https://github.com/SatangBudsai/knowai
cd knowlyx
...
Open a [GitHub issue](https://github.com/SatangBudsai/knowai/issues) with:
...
Open a [GitHub Discussion](https://github.com/SatangBudsai/knowai/discussions) first to align on direction. Knowlyx has a clear thesis (cognitive enforcement before code generation) — features that don't fit will be politely declined.
